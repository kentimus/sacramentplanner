...
namespace SacramentPlanner.Controllers
{
    public class MeetingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MeetingDate,ConductingLeader,OpeningSong,SacramentSong,ClosingSong,IntermediateSong,OpeningPrayer,ClosingPrayer")] Meeting meeting)
        {
